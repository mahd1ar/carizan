<template>
  ...
  <div class="w-full">
    ...
    <div v-if="cats[0]" class="relative flex h-[50vh] bg-primary">
      ...
      <div class="absolute flex h-full w-full items-center overflow-hidden bg-none sm:relative sm:w-5/12 sm:bg-primary">
        <!-- <img
    ...
    <div v-if="cats[1]" class="relative flex h-[50vh] flex-row-reverse bg-tm-gray-dark">
      ...
      <div class="relative flex w-4/12 items-center overflow-hidden bg-tm-gray-dark overflow-visible">
        <div class="container flex flex-col items-start justify-start gap-4">
          <h2 class="text-5xl font-semibold capitalize text-gray-200 md:text-7xl">
            {{ cats[1].name }}
          </h2>
